...
Flutter • Kotlin • Firebase • Java • .NET
...
### 👨‍💻 Whoami
I am an enthusiastic final-year Computer Science and Engineering (CSE) student pursuing my B.Sc. with a current CGPA of 3.59. I have hands-on experience in Flutter, Kotlin, Java, Dart, Firebase, C++, C#, .NET, HTML, and CSS, with a strong focus on Flutter-based Android and cross-platform application development. I enjoy building efficient, user-friendly applications and am eager to learn, collaborate with teams, and contribute to real-world software projects.
